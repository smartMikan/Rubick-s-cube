...
namespace Kociemba
{
    public class Tools
    {
        ...
        {
            EnsureFolder("Assets\\Resources\\SolveData\\");
            BinaryFormatter bf = new BinaryFormatter();
            Stream s = File.Open("Assets\\Resources\\SolveData\\" + filename + ".bytes", FileMode.Create);
        ...
        public static short[,] DeserializeTable(string filename)
        {
            ...
            TextAsset asset = Resources.Load("SolveData\\" + filename) as TextAsset;
        ...
        public static sbyte[] DeserializeSbyteArray(string filename)
        {
            TextAsset asset = Resources.Load("SolveData\\" + filename) as TextAsset;
            Stream s = new MemoryStream(asset.bytes);
            //Stream s = File.Open("Assets\\Resources\\SolveData\\" + filename, FileMode.Open);
            BinaryFormatter bf = new BinaryFormatter();
